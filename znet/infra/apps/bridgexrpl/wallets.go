...
const (
	// TXChainAdminMnemonic is the mnemonic used to set up the bridge on TX network.
	TXChainAdminMnemonic = "analyst evil lucky job exhaust inform note where grant file already exit vibrant come finger spatial absorb enter aisle orange soldier false attend response"
...
var RelayerMnemonics = []Mnemonics{
	{
		TXChain: "secret sun grow glide normal robust power crime rug food zone can card label blush pill exist culture hen indoor artefact spirit inner quality",
	...
	{
		TXChain: "stem clown area marriage tomorrow radio observe nephew gallery emerge ring bless sail gloom aerobic minimum can genuine clerk busy midnight mask bus alley",
	...
	{
		TXChain: "coast gain pill ridge emotion claim bus fashion liar feature earth victory shop paddle powder ring action vibrant churn kiss athlete frequent cover double",
	...
	{
		TXChain: "dice quick social basic morning defense birth silly embrace fatal tornado couple truck age obtain drama wheel mountain wreck umbrella spider present perfect large",
